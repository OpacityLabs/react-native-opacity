...
public:
  ...
  jsi::Value getUberDriverTrips(jsi::Runtime &rt, jsi::String startDate,
                                jsi::String endDate, jsi::String cursor);
  jsi::Value getUberFareEstimate(jsi::Runtime &rt, double pickupLatitude,
  ...
  jsi::Value getCartaPortfolioInvestments(jsi::Runtime &rt, jsi::String firm_id,
                                          jsi::String account_id);
  jsi::Value getCartaHoldingsCompanies(jsi::Runtime &rt,
                                       jsi::String account_id);
  jsi::Value getCartaCorporationSecurities(jsi::Runtime &rt,
                                           jsi::String account_id,
                                           jsi::String corporation_id);
  // github
